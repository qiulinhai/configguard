...
| `devices[].config_hash` | string (hex) | yes | Bare hex (no `sha256:` prefix). SHA-256 of the config file bytes. Phase 2 diff uses this for a fast skip-equal-configs pre-check. |
